...
function ProgramCard({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <img src={image} alt={title} className="h-56 w-full object-cover object-top sm:h-64 lg:h-72" />
        ...
        <div className="mx-auto grid max-w-7xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {instructors.map(([name, role, desc, image]) => (
            <div key={name} className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <img src={image} alt={name} className="h-56 w-full object-cover object-top sm:h-64 lg:h-72" />
